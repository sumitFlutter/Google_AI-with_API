...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Future.delayed(const Duration(seconds: 2),() {
      ...
      {
        itemScrollController.scrollTo(index: readObject!.qnaList.length-1,duration: Duration(seconds: 1));
      }
          ...
          Padding(
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                      ...
                      return Align(
                          ...
                          child: InkWell(
                              ...
                              showDialog(context: context, builder: (context) {
                                return AlertDialog(
                                  ...
                                  content: Column(mainAxisSize: MainAxisSize.min,
                                    children: [
                                    Text(watchObject!.qnaList[index].text!,style: const TextStyle(overflow: TextOverflow.ellipsis),),
                            ...
                            child: Container(padding: const EdgeInsets.all(10),
                              ...
                              decoration: BoxDecoration(color: watchObject!.qnaList[index].isQ==1?const Color(0xff452473):const Color(0xff1F2C33),
                ...
                watchObject!.isConnected? SizedBox(
                  height: MediaQuery
                      .sizeOf(context)
                      .height * 0.08,
                  width: MediaQuery
                  ...
                  child: TextField(controller: textEditingController,
                    ...
                    decoration: InputDecoration(
                        ...
                        suffixIcon: watchObject!.geminiModel!=null?IconButton(onPressed: () async {
                          FocusScope.of(context).requestFocus(FocusNode());
                          readObject!.getQ(textEditingController.text);
                          if(readObject!.qnaList.length>=5)
                            {
                              itemScrollController.jumpTo(index: readObject!.qnaList.length-1);
                            }
                        ...
                        }, icon: const Icon(Icons.send)):const SpinKitFadingCircle(size: 30,color: Colors.white,)),),
                ):
